import { c as create_ssr_component, b as add_attribute, i as is_void, v as validate_component, m as missing_component, f as escape, h as each } from "./index.js";
...
const DefaultListItem$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const defaultComponents = {
  ...
  listItem: {
    bullet: DefaultListItem$1,
    number: DefaultListItem$1
  },
  types: {},
  hardBreak: DefaultHardBreak,
  unknownBlockStyle: DefaultBlock,
  unknownList: DefaultList,
  unknownListItem: DefaultListItem$1,
...
const DefaultListItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { portableText = null } = $$props;
  if ($$props.portableText === void 0 && $$bindings.portableText && portableText !== void 0)
    $$bindings.portableText(portableText);
  return `<li class="list-disc">${slots.default ? slots.default({}) : ``}</li>`;
});
export {
  DefaultListItem as D,
  PortableText as P
};
